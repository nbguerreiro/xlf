...
11) Future usability features
  - [x] Configurable external commands: define commands and optional keybindings in commands.h; expose internal and external commands through the unified ':' dmenu menu, with dmenu also used for command prompts such as rename. (effort: medium)
